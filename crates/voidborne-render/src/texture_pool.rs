...
impl TexturePool {
    pub fn new() -> Self {
        Self { entries: Vec::new(), shadow_views: None }
    }
    ...
    pub fn rebuild(
        ...
        let color = wgpu::TextureUsages::RENDER_ATTACHMENT
        ...
        let mut push = |label: &'static str,
            ...
            PooledTexture { texture, view, format, width: tw, height: th }
        };
        ...
        // 5: SHADOW_CSM — Depth32Float array (4 cascades × 4096²)
        {
            ...
            let cascades =
                std::array::from_fn::<wgpu::TextureView, 4, _>(|i| {
