import { parseBlockProperties } from "~/engine/shaderpack/parse-block-properties";
import { parseDrawTargetsFromShaderSource } from "~/engine/shaderpack/parse-drawbuffers";
import { parseShadersProperties } from "~/engine/shaderpack/parse-properties";
import type {
  ShaderpackManifest,
  ShaderpackProgram,
  ShaderStageName,
